...
from lending.lending.doctype.loan_repayment_schedule.utils import (
	add_single_month,
	get_amounts,
...
class LoanRepaymentSchedule(Document):
	...
	if TYPE_CHECKING:
		...
		from lending.lending.doctype.co_lender_schedule.co_lender_schedule import (
			CoLenderSchedule,
		)
		from lending.lending.doctype.repayment_schedule.repayment_schedule import (
			RepaymentSchedule,
		)

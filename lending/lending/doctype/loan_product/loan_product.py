...
class LoanProduct(Document):
	...
	if TYPE_CHECKING:
		...
		from lending.lending.doctype.loan_charges.loan_charges import LoanCharges
		from lending.lending.doctype.loan_product_loan_partner.loan_product_loan_partner import (

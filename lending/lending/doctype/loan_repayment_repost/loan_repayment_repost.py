...
class LoanRepaymentRepost(Document):
	...
	if TYPE_CHECKING:
		...
		from lending.lending.doctype.loan_repayment_repost_cancel_detail.loan_repayment_repost_cancel_detail import (
			LoanRepaymentRepostCancelDetail,
		)
		from lending.lending.doctype.loan_repayment_repost_detail.loan_repayment_repost_detail import (

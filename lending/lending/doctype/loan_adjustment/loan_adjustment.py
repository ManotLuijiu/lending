...
from lending.lending.doctype.loan_restructure.loan_restructure import create_loan_repayment
...
class LoanAdjustment(Document):
	...
	if TYPE_CHECKING:
		...
		from lending.lending.doctype.loan_adjustment_detail.loan_adjustment_detail import (

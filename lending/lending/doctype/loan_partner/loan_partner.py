...
class LoanPartner(Document):
	...
	if TYPE_CHECKING:
		...
		from lending.lending.doctype.loan_partner_shareable.loan_partner_shareable import (
...
def get_colender_payout_details(posting_date):
	from lending.lending.doctype.loan_repayment.loan_repayment import get_bulk_due_details
